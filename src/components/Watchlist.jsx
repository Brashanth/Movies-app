    ...
    <>
      ...
      <div className="flex justify-center my-10">
        <input
          ...
          className="h-[3rem] w-[18rem] bg-gray-500/50 font-bold rounded-lg px-4 outline-none"
          type="text"
        ...
        <table className="w-full border-collapse text-left text-sm text-white">
          <thead>
            <tr className="bg-gray-500/50">
              <th className="px-6 py-4 text-sm font-bold text-white">Name</th>
              <th>
                <div className="flex">
                  <div>
                    <i
          ...
          <tbody className="divide-y divide-gray-100 border-t border-gray-100">
            {filteredMovies()
              .map((movie) => (
                <tr className="hover:bg-gray-500/50" key={movie.id}>
                  <td className="flex items-center px-6 py-4 font-normal text-gray-900 gap-4">
                    <img
                      className="h-[10rem] w-[8rem] object-fill object-cover rounded-lg"
